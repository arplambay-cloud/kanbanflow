  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className={`w-full flex items-center justify-between gap-2.5 bg-white border border-slate-200 text-slate-800 hover:border-slate-300 hover:bg-slate-50/50 focus:outline-none focus:ring-1 focus:ring-brand-600 focus:border-brand-600 transition-all font-medium shadow-sm ${sizeStyles[size]} ${
