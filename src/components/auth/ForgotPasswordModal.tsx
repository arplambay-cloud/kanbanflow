            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3.5 py-2.5 rounded-lg border border-slate-200 text-xs font-medium bg-white text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-600 transition-all"
                />
              </div>
            </div>
