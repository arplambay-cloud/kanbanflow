        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-white text-indigo-900 hover:bg-indigo-50 rounded-2xl font-semibold text-xs sm:text-sm shadow-md transition-all active:scale-95"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-700/60 hover:bg-indigo-700 text-white rounded-2xl font-semibold text-xs sm:text-sm border border-indigo-500/40 backdrop-blur-sm transition-all"
            >
            ...
            <div className="divide-y divide-slate-100">
              {myAssignedTasks.length === 0 ? (
                <div className="py-12 px-6 text-center">
                  ...
                  <button
                    onClick={() => openTaskModal()}
                    className="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-xl text-xs font-semibold shadow-sm hover:bg-indigo-700 transition-colors inline-flex items-center gap-1.5"
                  >
              ...
              {boards.slice(0, 4).map((board) => {
                ...
                return (
                  <div
                    ...
                    className="p-3.5 rounded-xl border border-slate-200 hover:border-indigo-300 hover:shadow-subtle cursor-pointer transition-all bg-slate-50/50 hover:bg-white"
                  >
