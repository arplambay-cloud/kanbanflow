    ...
    <Draggable draggableId={task.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`group relative bg-white p-3.5 rounded-lg border border-slate-200/90 shadow-subtle hover:shadow-card hover:border-slate-300 transition-all cursor-pointer select-none mb-2.5 ${
            snapshot.isDragging
              ? 'shadow-floating ring-2 ring-brand-500/80 rotate-1 scale-[1.02] z-50 bg-white'
              : ''
          }`}
        >
