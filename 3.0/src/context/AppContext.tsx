...
const LOCAL_STORAGE_KEYS = {
  WORKSPACE: 'kf3_v2_workspace',
  USERS: 'kf3_v2_users',
  CURRENT_USER_ID: 'kf3_v2_current_user_id',
  BOARDS: 'kf3_v2_boards',
  COLUMNS: 'kf3_v2_columns',
  TASKS: 'kf3_v2_tasks',
  NOTIFICATIONS: 'kf3_v2_notifications',
  ACTIVITY: 'kf3_v2_activity',
};
